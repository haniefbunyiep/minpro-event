/*
  ...
  - You are about to drop the column `eventFullname` on the `transactions` table. All the data in the column will be lost.
  ...
  - Added the required column `userFullname` to the `transactions` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `transactions` DROP COLUMN `eventFullname`,
    DROP COLUMN `userName`,
    ADD COLUMN `eventName` VARCHAR(191) NOT NULL,
    ADD COLUMN `userFullname` VARCHAR(191) NOT NULL;
